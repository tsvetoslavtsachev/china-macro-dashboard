...
==============================
Сканира journal/ и строи README.md — таблица с всички записи, групирани
по topic, сортирани по date descending.

Usage:
    python scripts/build_journal_index.py

Output: journal/README.md (в .gitignore — записът остава локален).
"""
